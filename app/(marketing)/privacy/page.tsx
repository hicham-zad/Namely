        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          <nav aria-label="Breadcrumb" className="text-sm mb-3" style={{ color: "var(--text3)" }}>
            <ol className="flex items-center gap-2">
              ...
              <li style={{ color: "var(--text)" }}>Privacy Policy</li>
            </ol>
          </nav>
          <h1 className="text-3xl md:text-4xl font-extrabold" style={{ fontFamily: "var(--font-outfit)", color: "var(--text)" }}>Privacy Policy</h1>
